...
This page covers tenant application setup in the dashboard.

Tenant apps are confidential clients for backend services and the Demo UI. They are not intended for browser-only clients.
...
<Note>
  App limits are tenant-scoped. If you need a higher app limit, contact
  support.
</Note>
...
<Tip>
  Your application still interacts with the platform API. It does not talk to
