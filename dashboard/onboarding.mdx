...
Welcome to TrueParser. This guide walks you through setting up your account and preparing your first application for real-time synchronization.
...
- Go to [dashboard.trueparser.com](https://dashboard.trueparser.com).
...
To ensure security and proper resource allocation, each new Tenant requires a one-time approval from the TrueParser team.
...
An App contains the configuration and credentials your backend uses to authenticate users and connect to TrueParser.
...
<Steps>
  ...
  <Step title="Region & Data Residency">
    ...
    Region**. TrueParser automatically provisions a regional database to store
    your app's metadata.
  </Step>
