---
title: "Introduction"
description: "High-performance orchestration for technical document parsing and data extraction."
---

TrueParser is a unified orchestration platform for technical and enterprise document parsing. It simplifies the complexity of extracting structured data from diverse formats—including GIS, CAD, SQL, and Office documents—into a single, high-performance API.

By decoupling parsing logic into specialized, independently versioned engines, TrueParser provides a robust infrastructure for intake, routing, normalization, and delivery.
...
<CardGroup cols={3}>
  ...
  <Card title="Streaming-First" icon="bolt">
    Native support for NDJSON streams ensures memory-efficient processing of even the largest documents.
  </Card>
  <Card title="Format Agnostic" icon="file-import">
    Built-in detection and routing for GIS, CAD, SQL, PDF, and Enterprise Office formats.
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="GIS & Geospatial" icon="map">
    SHP, GeoJSON, GPKG, KML, and more. Preserve spatial geometry and metadata.
  </Card>
  <Card title="CAD & Engineering" icon="drafting-compass">
    DWG and DXF. Maintain entities and technical layers in structured JSON.
  </Card>
...
<CardGroup cols={2}>
  ...
  <Card title="Architecture" icon="diagram-project" href="/internals/reliability">
