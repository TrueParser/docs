...
description: "Complete reference for TrueParser WebSocket close codes and Dashboard API errors."
---
...
| `4009` | Wrong Region | Document is active in another region | Parse the `REDIRECT:` URL from the close reason and reconnect to the supplied node URL. |
