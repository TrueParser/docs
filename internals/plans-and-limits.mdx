...
<Info>
  TrueParser limits apply to concurrent usage only, not total storage or document count. You can have unlimited documents in your system. Limits only apply to how many are actively open and syncing at the same time.
</Info>
...
See the [Pricing page](https://trueparser.com/pricing) for limit values per plan.
