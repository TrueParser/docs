...
Use this contract for CAD drawing results. It describes the public result shape for drawings and keeps the contract centered on the fields clients can rely on.
