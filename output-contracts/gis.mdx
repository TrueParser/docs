...
Use this contract for GIS and geospatial results. It describes the public result shape for spatial outputs and keeps the contract centered on the fields clients can rely on.
