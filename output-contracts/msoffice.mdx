...
Use this contract for Microsoft Office and web-text results. It describes the public result shape for Office and text outputs and keeps the contract centered on the fields clients can rely on.
