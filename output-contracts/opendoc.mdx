...
Use this contract for OpenDocument and related package outputs. It describes the public result shape for OpenDocument files and keeps the contract centered on the fields clients can rely on.
