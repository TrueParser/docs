...
Use this contract for PDF results. It describes the public result shape for PDF documents and keeps the contract centered on the fields clients can rely on.
