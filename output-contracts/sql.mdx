...
Use this contract for SQL statement results. It describes the public result shape for statements and keeps the contract centered on the fields clients can rely on.
