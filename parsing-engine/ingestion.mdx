...
- **CSV**: Requires a `csvRoute` to determine if it should be treated as a spatial GIS dataset or a tabular Office document.
- **PDF**: Can accept a `pdfMode` for specialized extraction (e.g., `SingleColumn`, `MultiColumn`).
